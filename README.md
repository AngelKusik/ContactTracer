...
- 📍 About this repository: ContactTracer: A repository containing my .Net Contact Tracer application, which is an application meant to enter customer information and track if customer has been contacted or not.
This application was created as a Lab 4 requirement for the Netd I course and introduced the use of classes within the course.
